<%-- 
    Document   : Borrar
    Created on : 13/05/2021, 01:45:51 PM
    Author     : AndrewSword
--%>
        ...
        <div class="Contenedor">
            ...
            <section>
                <table>
                    ...
                    <th class="eliminarT2"><a href="Controlador?accion=Eliminar&id=<%= E.getId()%>">Eliminar</a>
                        <% } %>
                    </tbody>
                </table>
            </section>
